...
public class NumberFilterAdapter extends RecyclerView.Adapter<NumberFilterAdapter.ContactHolder>
{
    ...
    public NumberFilterAdapter(List<Contact> contactList, mClickListener klik)
    {
        this.klik = klik;
